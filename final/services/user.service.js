// Encapsulates data access and business logic for users
// Exposes methods for CRUD operations and user authentication

// promises used to keep users api controller simple: methods can be called with [servicemethod].then(...).catch(...);
...
function update(_id, userParam) {
    ...
    function updateUser() {
        // fields to update TODO: add middle name
        var set = {
